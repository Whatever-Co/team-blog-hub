...
export function PostRow({
  ...
  const gridClass = showAuthor
    ? "grid-cols-[92px_52px_1fr_110px]"
    : "grid-cols-[92px_52px_1fr]";
  return (
    <a
      href={post.link}
      target="_blank"
      rel="noopener noreferrer"
      className={`grid ${gridClass} gap-[18px] items-center py-[18px] border-b border-dashed border-[color:var(--color-rule-dashed)] hover:bg-[color:var(--color-hover)]`}
    >
